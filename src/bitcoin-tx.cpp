...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pubgcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pubgcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pubgcoin transaction") + "\n" +
              "  pubgcoin-tx [options] -create [commands]   " + _("Create hex-encoded pubgcoin transaction") + "\n" +
              "\n";
