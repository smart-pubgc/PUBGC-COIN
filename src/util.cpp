...
const char * const BITCOIN_CONF_FILENAME = "pubgcoin.conf";
const char * const BITCOIN_PID_FILENAME = "pubgcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pubgcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pubgcoin";
#else
    // Unix
    return pathRet / ".pubgcoin";
#endif
#endif
}
