...
#if defined(NDEBUG)
# error "Pubgcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pubgcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PUBGC additional fees, %d delta bytes\n",
