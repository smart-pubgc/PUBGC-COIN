...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pubgcoin-project/pubgcoin>";
    const std::string URL_WEBSITE = "<https://pubgcoin.org>";
